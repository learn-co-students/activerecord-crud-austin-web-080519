...
def can_be_created_in_a_block(title: title='Home Alone', release_date: release_date=1990)
...
def can_update_using_update_method
  ...
  newm = Movie.update(title: "Wat, huh?").first
  newm.save
end
...
def can_destroy_a_single_item
  ...
  move = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  move.destroy
end
